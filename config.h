...
static const char col_gray3[]       = "#e3e0d5";
static const char col_gray4[]       = "#333333";
static const char col_yellow[]      = "#bdb3a0";
static const char col_cyan[]        = "#3689e6";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]  = { col_gray3, col_gray4,  col_yellow  },
};
...
static const Rule rules[] = {
	...
	{ "Google-chrome",  "playapplemusic.com",       NULL,       1 << 0,       0,           1 },
	{ "Google-chrome",  "trello.com",       NULL,       1 << 3,       0,           -1 },
};
...
static const char *pmenucmd[] = { "passmenu", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_gray4, "-sf", col_gray3, NULL };
static const char *displaycmd[] = { "displaymenu", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_gray4, "-sf", col_gray3, NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_p,      spawn,          SHCMD("dock") },
